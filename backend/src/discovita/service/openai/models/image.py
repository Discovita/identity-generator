...
class ImageSize(str, Enum):
    ...
    Used in:
    - openai/core/image/mixin.py - for specifying image dimensions
...
class ImageQuality(str, Enum):
    ...
    Used in:
    - openai/core/image/mixin.py - for specifying image quality
...
class ImageStyle(str, Enum):
    ...
    Used in:
    - openai/core/image/mixin.py - for specifying image style
...
class ImageResponseFormat(str, Enum):
    ...
    Used in:
    - openai/core/image/mixin.py - for specifying response format
...
class ImageModel(str, Enum):
    ...
    Used in:
    - openai/core/image/mixin.py - for specifying which model to use
